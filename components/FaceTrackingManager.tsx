...
export const FaceTrackingManager: React.FC<FaceTrackingManagerProps> = ({
    ...
    useEffect(() => {
        if (showDebug && isCameraActive && videoRef.current && debugVideoRef.current) {
    ...
    const predict = useCallback(() => {
        ...
        // 2. Debug Drawing
        if (showDebug && debugCanvasRef.current && debugVideoRef.current) {
        ...
        requestRef.current = requestAnimationFrame(predict);
    }, [faceLandmarker, isTracking, showDebug, onHeadMove, onEyeGaze]);
        ...
        <div className="pointer-events-none">
            ...
            <div className="relative">
                <AnimatePresence>
                    {showDebug && (
                        <motion.div
                            className="fixed bottom-20 right-4 z-[99] rounded-xl overflow-hidden shadow-2xl border border-white/20 bg-black/50 backdrop-blur-sm pointer-events-none"
