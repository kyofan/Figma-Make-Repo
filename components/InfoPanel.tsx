  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-white/70 font-light mb-4">
        This prototype demonstrates a new paradigm for text input in spatial
        computing that combines:
      </p>
      <ul className="text-sm space-y-3">
        <li className="flex items-start">
          ...
          <span className="text-white/80 font-light">
            <strong className="font-normal">Eye tracking</strong> (simulated
            with mouse hover)
          </span>
        </li>
        <li className="flex items-start">
          ...
          <span className="text-white/80 font-light">
            <strong className="font-normal">Voice commands</strong> (press space
            to activate)
          </span>
        </li>
        <li className="flex items-start">
          ...
          <span className="text-white/80 font-light">
            <strong className="font-normal">Contextual understanding</strong>{" "}
            (grammar correction)
          </span>
        </li>
      </ul>
