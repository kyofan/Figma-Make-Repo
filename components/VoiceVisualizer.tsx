      ...
      const updateVisualization = () => {
        ...
        if (analyserRef.current && dataArrayRef.current) {
          ...
          const newHeights = Array(16).fill(0).map((_, i) => {
            const dataIndex = Math.floor(i * (dataArrayRef.current!.length / 16));
          ...
          setBarHeights(Array(16).fill(0).map(() => 5 + Math.random() * 20));
        }
    ...
    <>
      ...
      <AnimatePresence>
        {micPermissionStatus === 'denied' && (
          ...
          >
            <p className="mb-2">Microphone access denied. Voice input won't work.</p>
            <button 
        ...
        {isListening && (
          ...
          >
            ...
            {speechData?.text && (
              ...
              >
                ...
                <div className="text-lg">
                  {speechData.text || <span className="text-white/30 italic">Listening...</span>}
                </div>
              </motion.div>
            )}
            ...
            >
              ...
              <span className="ml-4 text-white/80 font-light text-sm">Listening...</span>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
